    ...
    private static final DiffUtil.ItemCallback<CourseModal> DIFF_CALLBACK =
            new DiffUtil.ItemCallback<CourseModal>() {
                ...
                public boolean areContentsTheSame(CourseModal oldItem, CourseModal
                        newItem) {
                    // a linha abaixo é para verificar o nome do curso, descrição e
                    //duração do curso.
...
// para cada item de nossa visualização do reciclador.
    ...
    // criando um método para obter o modal do curso para uma posição
    //específica.
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(@NonNull View itemView) {
            ...
            // adicionando ouvinte de clique para cada item da visualização do
            //reciclador.
                    itemView.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            // dentro do listener do clique, estamos passando a
                            //posição para
