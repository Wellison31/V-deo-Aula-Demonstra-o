    ...
    private static RoomDatabase.Callback roomCallback = new
            RoomDatabase.Callback() {
                ...
                public void onCreate(@NonNull SupportSQLiteDatabase db) {
                    super.onCreate(db);
                    // este método é chamado quando o banco de dados é criado e a
                   //inha abaixo é para preencher nossos dados.
                            new PopulateDbAsyncTask(instance).execute();
                }
            };
    // estamos criando uma classe de tarefa assíncrona para realizar a tarefa
   //em segundo plano.
